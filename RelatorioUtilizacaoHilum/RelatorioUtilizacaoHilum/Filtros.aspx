<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Filtros.aspx.cs" Inherits="RelatorioUtilizacaoHilum.Filtros" %>
...
<body>
    ...
    <div style="height: 264px; width: 551px" align="left" >
    
          <table class="auto-style3"  cellpadding="3" cellspacing="3" style="background-color: #F9F9F9" align="center">
            <tr>
            ...
            <tr>
                ...
                <td class="auto-style8" style="font-family: Arial; font-size: 11px; font-weight: bold; color: #333333; background-color: #F9F9F9; text-transform: none;">
                    <asp:DropDownList ID="ddlPrestadores" runat="server" Width="216px" TabIndex="1" Height="20px" Font-Size="Small" AppendDataBoundItems="True">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td class="auto-style17" style="font-family: Verdana; font-size: 10px; font-weight: bold; color: #5C5C5C; background-color: #F9F9F9">
                    <asp:TextBox  ID="txtDtInicial"  runat="server" Width="73px" MaxLength="10" TabIndex="2"></asp:TextBox>
&nbsp;&nbsp;&nbsp; Até&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="txtDtFinal" runat="server" Width="73px" MaxLength="10" TabIndex="3"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style7" style="padding-left: 20px; color: #004E99; font-weight: bold; font-size: 13px; background-color: #F9F9F9; vertical-align: middle;">Tipo Operação:</td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                <td class="auto-style8" style="padding-left: 20px; color: #004E99; font-weight: bold; font-size: 13px; background-color: #F9F9F9; vertical-align: middle;">Transações:</td>
                <td class="auto-style8" style="font-family: Verdana; font-size: 9px; font-weight: bold; color: #5C5C5C; background-color: #F9F9F9; text-align: left;">
                    <asp:RadioButton ID="rdbConsulta" runat="server" Checked="True" GroupName="grpTpTransacao" Text="Consulta" TabIndex="7" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:RadioButton ID="rdbSADT" runat="server" GroupName="grpTpTransacao" Text="SADT" TabIndex="8" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:RadioButton ID="rdbInternacao" runat="server" Enabled="False"  GroupName="grpTpTransacao" Text="Internações" TabIndex="9" Visible="False" />
 &nbsp;                   
                    <asp:RadioButton ID="rdbTodasTpTransacao" runat="server" Enabled="False" GroupName="grpTpTransacao" Text="Todas" TabIndex="10" Visible="False" />
                </td>
            </tr>
            <tr>
...
&nbsp;&nbsp;&nbsp;
                    <asp:RadioButton ID="rdbTodas" runat="server" GroupName="grpSituacao" Text="Todas" TabIndex="10" Visible="False" />
                </td>
            </tr>
            <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                <td align="center" class="auto-style12" colspan="2" style="font-family: Verdana; background-color: #F9F9F9;" valign="bottom">
                    <asp:Button ID="btExecutarRelatorio" runat="server" BackColor="#4A864A" target="_blank" BorderColor="#009ACE" ForeColor="White" Text="Visualizar" TabIndex="17" OnClick="btExecutarRelatorio_Click" />
